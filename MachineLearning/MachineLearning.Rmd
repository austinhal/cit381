...
ggplot(sal, aes(age)) +
  ...
  theme_bw() +
  labs(main="Peak adult total income at 31",
       x="Age",
       y="Count")
...
ggplot(sal, aes(hour_week)) + 
  ...
  theme_bw() +
  labs(main="People working more than 40 have larger incomes",
...
ggplot(sal, aes(region)) +
  ...
  theme_bw() +
  labs(main="North America Accounts for most generated income",
       x="Region",
       y="Count")
```
